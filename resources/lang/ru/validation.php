...
return [
   ...
   "country" => "Гэта поле несапраўдная краіна.", 
   ...
   "password.letters" => "Гэта поле павінна змяшчаць хаця б адну літару.", 
   "password.mixed" => "Гэта поле павінна змяшчаць як мінімум адну вялікую і адну малую літары.", 
   "password.numbers" => "Гэта поле павінна змяшчаць хаця б адну лічбу.", 
   "password.symbols" => "Гэта поле павінна змяшчаць хаця б адзін сімвал.", 
   "password.uncompromised" => "Дадзенае поле з'явілася ў выніку ўцечкі даных. Выберыце іншае поле.", 
   ...
   "required" => "эта поле :attribute абавязковым.", 
